								...
								<div class="spotlight">
									<div class="content">
										...
										<table class="alt">
													...
													<tr>
														<td colspan="3" align="right"><input type="submit" class="button primary" value="<spring:message code="message.introduction.login" />"> 
														<a href="signin.jsp" class="button primary"><spring:message code="message.introduction.sign" /></a> </td>
													</tr>
												</tbody>
										</table>
										</form>
